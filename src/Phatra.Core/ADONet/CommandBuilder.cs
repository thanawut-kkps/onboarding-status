...
namespace Phatra.Core.AdoNet
{
    public class CommandBuilder
    {
        ...
        /// <summary>
        /// Builder method - sets the command with no timeout
        /// </summary>
        public CommandBuilder WithNoTimeout()
        {
        ...
        class Executor
        {
            ...
            private void LogExecutionFinished()
            {
                Logger.LogMessage("--Call database finished--");
            }
